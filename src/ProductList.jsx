...
function ProductList({ onHomeClick }) {
  ...
  // 1. PULL CART ITEMS FROM REDUX STATE
  const cart = useSelector((state) => state.cart.items);

  // 2. CALCULATE THE TOTAL QUANTITY DYNAMICALLY
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart">
                ...
                >
                  ...
                  <path d="M223.9,129.7l-15.4,53.8A16,16,0,0,1,193,196H98.3a16,16,0,0,1-15.4-12.5L55.2,76H24a8,8,0,0,1,0-16H59.2a8,8,0,0,1,7.7,6.1L78,116H216a8,8,0,0,1,7.9,9.7ZM96,204a12,12,0,1,0,12,12A12,12,0,0,0,96,204Zm80,0a12,12,0,1,0,12,12A12,12,0,0,0,180,204Z"></path>
                </svg>
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    {/* Fixed double dollar sign issue here too */}
